...
function loadBlogs(n) {
  ...
  for (i = 0; i < n; ++i) {
    ...
    content.className = "blog_content";
    ...
    description.className = "blog_description";
    description.innerText = blogs[i].description;
    content.appendChild(description);

    const view_blog = document.createElement("a");
    view_blog.className = "view_blog_btn";
    view_blog.innerText = "View Blog";
    view_blog.href = "#";
    content.appendChild(view_blog);
